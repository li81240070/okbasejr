 ...
 */
public class EvaluationOrderPage extends Fragment{
    private Context context;
    private PostCardList evaluationOrderListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view=LayoutInflater.from(getContext()).inflate(R.layout.evaluationorderpage,null);
...
//与接收系统的一样
        ...
        evaluationOrderListView= (PostCardList) view.findViewById(R.id.evaluationOrderListView);
        ...
        NetLoader.getInstance(getContext()).loadGetData(getActivity(), url, new NetLoader.NetResponseListener() {
            ...
            public void success(String resultString, int code) {
                ...
                for (int i = 0; i < orderClass.getDataMap().getOrders().size(); i++) {
                    if (orderClass.getDataMap().getOrders().get(i).getOrder_status().equals("6")||
                            orderClass.getDataMap().getOrders().get(i).getOrder_status().equals("7")||
                            orderClass.getDataMap().getOrders().get(i).getOrder_status().equals("8")
                            ){
                ...
                evaluationOrderListView.setAdapter(adapter);
