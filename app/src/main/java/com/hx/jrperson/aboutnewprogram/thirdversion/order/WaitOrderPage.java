 ...
 */
public class WaitOrderPage extends Fragment{
    private Context context;
    private PostCardList waitOrderListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view=LayoutInflater.from(getContext()).inflate(R.layout.waitorderpage,null);
        //注册广播接受者
        //创建新的广播接收者
...
//与接收系统的一样
        ...
        waitOrderListView= (PostCardList) view.findViewById(R.id.waitOrderListView);
        ...
        NetLoader.getInstance(getContext()).loadGetData(getActivity(), url, new NetLoader.NetResponseListener() {
            ...
            public void success(String resultString, int code) {
                ...
                for (int i = 0; i < orderClass.getDataMap().getOrders().size(); i++) {
                    if (orderClass.getDataMap().getOrders().get(i).getOrder_status().equals("5")
                            ){
                ...
                waitOrderListView.setAdapter(adapter);
